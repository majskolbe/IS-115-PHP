...
$produktInfo = $scanner->skannProdukt('7038010010187'); //grandis

if ($produktInfo) {
    echo "{$produktInfo['navn']} ({$produktInfo['merke']})<br>";
    echo "<img src='{$produktInfo['bilde']}' width='150'><br>";

    echo "Billigste pris: {$produktInfo['priser'][0]['pris']} kr hos {$produktInfo['priser'][0]['butikk']}<br><br>";
